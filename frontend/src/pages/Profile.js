...
function Profile() {
    ...
    // Hàm nén ảnh để giảm kích thước
    const compressImage = (base64String, quality = 0.7, maxSize = 500000) => {
        return new Promise((resolve) => {
            ...
            img.onload = () => {
                ...
                // Nếu vẫn quá lớn, tiếp tục giảm quality
    ...
    const handleSellerRequestSubmit = async (e) => {
        e.preventDefault();
        if (!window.confirm('Bạn có chắc chắn muốn gửi hồ sơ đăng ký làm người bán?')) return;
        ...
        try {
            // Gửi toàn bộ thông tin hồ sơ bán hàng
            ...
            await submitSellerRequest(user.id, sellerData);
            setSuccess('✅ Hồ sơ đăng ký làm người bán đã được gửi thành công! Vui lòng chờ phê duyệt từ Quản trị viên.');
            ...
            window.scrollTo(0, 0);
            // Tự động reset thông báo sau 5 giây
            setTimeout(() => {
                setSuccess('');
            }, 5000);
        } catch (err) {
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <div className="avatar-upload-container">
                                            ...
                                            <small className="form-text text-muted d-block mt-2">
                                                Chọn ảnh để đặt làm avatar (Kích thước: Dưới 2MB)
                                            </small>
                                        </div>
                                    </div>
                            ...
                            <div className="p-4">
                                {user.role === 'seller' ? (
                                    <div className="alert alert-success mb-0">
                                        ...
                                        Bạn hiện đang là Đối tác Người bán trên hệ thống TechShop.
                                    </div>
                                ) : user.sellerStatus === 'pending' ? (
                                    <div className="alert alert-warning mb-0">
                                        <i className="bi bi-hourglass-split me-2"></i>
                                        Yêu cầu trở thành người bán của bạn đang chờ Quản trị viên phê duyệt.
                                    </div>
                                ) : showSellerForm ? (
                                    <form onSubmit={handleSellerRequestSubmit} className="seller-register-form mt-3">
                                        ...
                                        <div className="row mb-4">
                                            ...
                                            <div className="col-md-6 mb-3">
                                                <label className="form-label">Email (Tự động)</label>
                                        ...
                                        <div className="row mb-4">
                                            ...
                                            <div className="col-md-12 mb-3">
                                                <label className="form-label">Logo Shop (Tùy chọn)</label>
                                        ...
                                        <div className="row mb-4">
                                            ...
                                            <div className="col-md-6 mb-3">
                                                <label className="form-label">Giấy phép kinh doanh (Tùy chọn)</label>
                                            ...
                                            <div className="col-md-6 mb-3">
                                                ...
                                                <input type="text" className="form-control" name="bankAccount" placeholder="VD: 123456789 - VCB - Nguyen Van A" value={sellerForm.bankAccount} onChange={handleSellerChange} required />
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <p>Trở thành người bán để bắt đầu đăng bán sản phẩm của riêng bạn và tiếp cận hàng ngàn khách hàng trên TechShop.</p>
