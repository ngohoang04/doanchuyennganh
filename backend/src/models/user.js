...
module.exports = (sequelize, DataTypes) => {
  ...
  User.init({
    ...
    idCardFront: { type: DataTypes.TEXT('long'), field: 'id_card_front' },
    idCardBack: { type: DataTypes.TEXT('long'), field: 'id_card_back' },
    businessLicense: { type: DataTypes.TEXT('long'), field: 'business_license' },
    bankAccount: { type: DataTypes.STRING, field: 'bank_account' },
    bankQrImage: { type: DataTypes.TEXT('long'), field: 'bank_qr_image' },
    shopLogo: { type: DataTypes.TEXT('long'), field: 'shop_logo' },
